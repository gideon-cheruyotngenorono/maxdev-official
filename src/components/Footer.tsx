...
const footerLinks = {
  ...
  services: [
    ...
    { label: 'Cybersecurity', path: '/security' },
  ],
  social: [
    { label: 'TikTok', url: 'https://tiktok.com/@maxdev', icon: 'tiktok' },
    { label: 'YouTube', url: 'https://youtube.com/@maxdev', icon: 'youtube' },
    { label: 'Facebook', url: 'https://facebook.com/maxdev', icon: 'facebook' },
    { label: 'Instagram', url: 'https://instagram.com/maxdev', icon: 'instagram' },
    { label: 'WhatsApp', url: 'https://wa.me/254746093533', icon: 'whatsapp' },
  ]
}
      ...
      <div className="container">
        <div className="footer-grid">
          <div className="footer-brand">
            ...
            <p>Building powerful digital experiences for global clients. Elite fullstack development, AI integration, and security solutions.</p>
            <div className="footer-social">
              {footerLinks.social.map(s => (
                <a key={s.icon} href={s.url} target="_blank" rel="noopener noreferrer" className="social-icon" aria-label={s.label}>
          ...
          <div className="footer-col">
            <h4>Contact</h4>
            <a href="https://wa.me/254746093533" target="_blank" rel="noopener noreferrer">+254 746 093 533</a>
            <a href="https://wa.me/254701648600" target="_blank" rel="noopener noreferrer">+254 701 648 600</a>
            <a href="mailto:maxronoh@maxdev.com">maxronoh@maxdev.com</a>
        ...
        <div className="footer-bottom">
          <p>© {new Date().getFullYear()} MAX DEV. All rights reserved.</p>
          <p className="footer-terms">
            Clients pay 40% deposit after prototype approval. Remaining 60% upon final delivery.
          </p>
        </div>
      </div>
    </footer>
